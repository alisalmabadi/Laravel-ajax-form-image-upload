                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <div class="well" style="height:400px;">
                                            ...
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/1.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/7.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/8.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/2.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/3.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/4.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/5.jpg')}}">
                                            <img style="cursor:pointer;width:90px;height:120px;" class="img-polaroid" src="{{asset('img/phones/designs/6.jpg')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
