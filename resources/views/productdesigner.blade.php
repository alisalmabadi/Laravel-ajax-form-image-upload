    ...
    <div class="fpd-right">
        <div class="fpd-more fpd-btn fpd-dropdown" >
            ...
            <div class="fpd-dropdown-menu fpd-shadow-1  fpd-scale-tr">
                <span class="fpd-download-image fpd-btn" style="display: block;"><?php echo $download_image; ?></span>
                <span class="fpd-save-pdf fpd-btn" style="display: block;"><?php echo $pdf; ?></span>
                <span class="fpd-print fpd-btn" style="display: block;"><?php echo $print; ?></span>
                <span class="fpd-save-product fpd-btn" style="display: block;"><?php echo $save_product; ?></span>
                <span class="fpd-load-saved-products fpd-btn" style="display: block;"><?php echo $load_saved_products; ?></span>
            </div>
